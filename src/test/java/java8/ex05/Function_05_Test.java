...
public class Function_05_Test {
    ...
    Consumer<Person> changePasswordToSecret = (Person person) -> person.setPassword("secret");

    // TODO compléter la fonction
    // TODO vérifier que l'age > 4 avec une assertion JUnit
    Consumer<Person> verifyAge = (Person person) -> assertTrue(person.getAge() > 4);

    // TODO compléter la fonction
    // TODO vérifier que le mot de passe est "secret" avec une assertion JUnit
    Consumer<Person> verifyPassword = (Person person) -> assertTrue(person.getPassword().equals("secret"));
    //end::functions[]
    ...
    public void test_consumer() throws Exception {
        ...
        // TODO invoquer la méthode personList.forEach pour modifier les mots de passe en "secret"
         personList.forEach((Person person) -> person.setPassword("secret"));
        ...
        // TODO Utiliser la méthode andThen pour chaîner les vérifications verifyAge et verifyPassword
         personList.forEach((Person person) -> verifyAge.andThen(verifyPassword).accept(person));
