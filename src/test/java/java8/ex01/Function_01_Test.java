...
public class Function_01_Test {
    ...
    private Function<Integer, Person> intToPerson = (Integer i) -> new Person("first_" + i, 
    		"last_" + i, 
    		i, 
    		"pass_" + i);
    // end::intToPerson[]
    ...
    private Function<Integer, Account> intToAccountWithCompose = (Integer entier) -> {
    	
    	Account account = personToAccount.compose(intToPerson).apply(entier);
    ...
    private Function<Integer, Account> intToAccountWithAndThen = (Integer entier) -> {
    	
    	Account account = intToPerson.andThen(personToAccount).apply(entier);
    	return account;
