...
public class Stream_04_Test {
    ...
    public void test_of() throws Exception {
        ...
        Stream<String> result = Stream.of("Alexandra", "Johnny", "Sophie", "Cyril", "Marion")
        		.sorted();
    ...
    public void test_iterate() throws Exception {
        ...
        Stream<Integer> result1 = Stream.iterate(1, i -> i)
        		.limit(5);
        Stream<Integer> result2 = Stream.iterate(1, i -> i + 1)
        		.limit(5);
