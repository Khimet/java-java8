...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_of() {
        ...
        LocalDateTime result = LocalDateTime.of(LocalDate.of(2018, 1, 1), LocalTime.of(12, 0, 0));
    ...
    public void test_localDateTime_parse() {
    	...
    	DateTimeFormatter formatter = DateTimeFormatter.ofPattern("d MMMM yyyy à HH'h'mm'm'ss's'", 
    			Locale.FRANCE);
//    	DateTimeFormatter frenchFmt = formatter.withLocale(Locale.FRENCH);
    	LocalDateTime result = LocalDateTime.parse("2 mars 2009 à 09h30m00s", formatter);
